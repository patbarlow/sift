        ...
        VStack(alignment: .leading, spacing: 4) {
            HStack(spacing: 6) {
                Image(systemName: todo.statusEnum == .archived ? "archivebox.fill" : "checkmark.circle.fill")
                    ...
                    .frame(width: 16)
                    .padding(.trailing, 6)
                Text(SlackText.inlineCodeStyled(todo.displayTitle.redacting(settings.redactionEnabled), font: .system(.body, design: .monospaced)))
        ...
        VStack(alignment: .leading, spacing: 4) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                if !todo.summary.isEmpty {
                    Text(SlackText.inlineCodeStyled(todo.displaySummary.redacting(settings.redactionEnabled), font: .system(.callout, design: .monospaced)))
